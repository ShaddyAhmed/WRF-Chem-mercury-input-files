function mx = nan_mean(x)
%NAN_MEAN  Mean of available data, ignoring NaNs.
%
%    NAN_MEAN(X) returns the mean of the available data in X, treating
%    NaNs as missing values. For vectors, NAN_MEAN(X) is the mean value
%    of the non-NaN elements in X.  For matrices, NAN_MEAN(X) is a row
